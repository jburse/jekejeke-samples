...
runner:ref(nl, 0, stream_text, 'ISO 8.12.3').
runner:case(nl, 0, stream_text, 1) :-
...
runner:case(put_char, 1, stream_text, 1) :-
   with_output_to(atom(X), put_char(t)),
   X == t.
runner:case(put_char, 1, stream_text, 2) :-
   catch(put_char(_), error(E,_), true),
   E == instantiation_error.
runner:case(put_char, 1, stream_text, 3) :-
...
runner:case(put_code, 1, stream_text, 1) :-
   with_output_to(atom(X), put_code(116)),
   X == t.
runner:case(put_code, 1, stream_text, 2) :-
   catch(put_code(_), error(E,_), true),
   E == instantiation_error.
runner:case(put_code, 1, stream_text, 3) :-
...
runner:case(peek_char, 1, stream_text, 1) :-
   with_input_from(atom('qwerty '), peek_char(X)),
   X == q.
runner:case(peek_char, 1, stream_text, 2) :-
...
runner:case(peek_code, 1, stream_text, 1) :-
   with_input_from(atom('qwerty '), peek_code(X)),
   X == 113.
runner:case(peek_code, 1, stream_text, 2) :-
...
runner:case(peek_code, 1, stream_text, 5) :-
...
runner:case(get_char, 1, stream_text, 1) :-
   with_input_from(atom('qwerty '), get_char(X)),
   X == q.
runner:case(get_char, 1, stream_text, 2) :-
...
runner:case(get_code, 1, stream_text, 1) :-
   with_input_from(atom('qwerty '), get_code(X)),
   X == 113.
runner:case(get_code, 1, stream_text, 2) :-
...
runner:case(get_code, 1, stream_text, 5) :-
