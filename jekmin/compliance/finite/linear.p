...
runner:case('sys_const sys_mulv', 5, finite_linear, 'CLP(FD) 0.8.3, 1.8, XLOG 2') :-
   call_residue((Z #= X*Y, Z = 12), L), equal(L, [Y in -12..12, 12 #= X*Y]).
