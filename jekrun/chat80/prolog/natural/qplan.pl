/**
 * Prolog text qplan from Chat80 as a module.
 *
 * Warranty & Liability
...
incorporate(P0, V0, C0, P1, [_, L1], [P1|L]) :- incorporate(P0, V0, C0, _, L1, L).
...
setcontains(_-V, N) :- N < 18, !, V/\1<<N =\= 0.
setcontains(W-_, N) :- !, N1 is N-18, setcontains(W, N1).
setcontains(V, N) :- N < 18, V/\1<<N =\= 0.

intersect(W1-V1, W2-V2) :- !, (V1/\V2 =\= 0; intersect(W1, W2)), !.
intersect(_-V1, V2) :- !, V1/\V2 =\= 0.
intersect(V1, _-V2) :- !, V1/\V2 =\= 0.
intersect(V1, V2) :- V1/\V2 =\= 0.

disjoint(W1-V1, W2-V2) :- !, V1/\V2 =:= 0, disjoint(W1, W2).
disjoint(_-V1, V2) :- !, V1/\V2 =:= 0.
disjoint(V1, _-V2) :- !, V1/\V2 =:= 0.
