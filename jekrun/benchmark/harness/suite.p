...
rsuite :-
   bench(301, dummy, _, _),
   bench(1201, nrev, T1, G1),
   bench(61, crypt, T2, G2),
   bench(6001, deriv, T3, G3),
   bench(12, poly, T4, G4),
   bench(1201, qsort, T5, G5),
   bench(2, tictac, T6, G6),
   bench(3, queens, T7, G7),
   bench(601, query, T8, G8),
   bench(6, mtak, T9, G9),
   bench(2, perfect, T10, G10),
   bench(2001, calc, T11, G11),
   T is T1+T2+T3+T4+T5+T6+T7+T8+T9+T10+T11,
   G is G1+G2+G3+G4+G5+G6+G7+G8+G9+G10+G11,
   write('Total'),
   show(T, G), nl.