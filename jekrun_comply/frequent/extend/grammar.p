...
runner:case(!, 2, extend_grammar, 'WG17 DCGD 7.14.10, XLOG 6') :-
   \+ phrase((p -> t(X), !, t(X); []), [abc, abc, xyz, abc, xyz], _).
runner:case(!, 2, extend_grammar, 'WG17 DCGD 7.14.10, XLOG 7') :-
   phrase((r, (!; p)), [abc], X), X == [abc].
